...
function main() {
    ...
    reporter "installing nvidia drivers (if necessary)"
    if [[ !-z $(lspci | grep 'VGA.*NVIDIA') ]]; then
    ...
    reporter "installing google play music"
    ...
    sudo dpkg -i /tmp/google-play-music*.deb
